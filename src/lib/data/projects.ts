import firona from '$lib/assets/images/portfolio/firona.png?enhanced';
import kuechenwerkstatt from '$lib/assets/images/portfolio/kuechenwerkstatt.png?enhanced';
...
export const projects = [
    {
        image: firona,
        title: `Firona`,
        description: `Ein Einsatzalarmierungssystem für die Jugendfeuerwehr – entwickelt für Übungsabende und Berufsfeuerwehrtage.`,
        technologies: [`Svelte`, `TailwindCSS`],
        href: `https://firona.de/`
    },
    {
        image: kuechenwerkstatt,
        title: `Küchenwerkstatt Webseite`,
        description: `Ein moderner Webauftritt für die Küchenwerkstatt Flensburg mit Fokus auf Küchenplanung aus Montageerfahrung, Referenzen, Beratungsablauf und lokaler Kontaktaufnahme.`,
        technologies: [`Svelte`, `TailwindCSS`],
    },
    {
        image: heideKuester,
